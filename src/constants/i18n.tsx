...
const en = {
  ...
  errBirthDate: "Please fill in a valid date of birth",
...
const idDict: Record<keyof typeof en, string> = {
  ...
  errPhone: "No. HP wajib diisi",
  errPhoneInvalid: "Nomor HP tidak valid",
  errBirthDate: "Isi tanggal lahir dengan benar",
